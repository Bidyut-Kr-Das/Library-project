                ...
                <div id="marginDiv1">
                    <form action="">
                        ...
                        <div class="Bookname slide-right-bookName">
                            ...
                            <input type="text" name="bookName" id="bookName" value="<?php echo $oldBookName;?>"required autocomplete="off">
                        </div>
                        <div class="author slide-right-author">
                            <label for="author">Author</label>
                            <input type="text" name="author" id="author" value="<?php echo $oldAuthor;?>"required autocomplete="off">
                        </div>
                        <div class="description slide-right-description">
                            <label for="description">Description</label>
                            <textarea name="desc" id="description" maxlength="500"value="<?php echo $oldDescription;?>"></textarea>
                        </div>
                        <div class="bookId slide-right-bookId">
                            <label for="bookId">Book ID</label>
                            <input type="text" name="bookId" id="bookId" value="<?php echo $oldBookId;?>"required autocomplete="off">
                        </div>
                        <div class="quantity slide-right-quantity">
                            <label for="quantity">Quantity</label>
                            <input type="number" name="quantity" id="quantity" value="<?php echo $oldQuantity;?>"required autocomplete="off">
                        </div>
